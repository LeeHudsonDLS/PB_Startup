...
//------------------------------------------------------------------------------------
// global _PPScriptMode_	// uncomment for Pmac Script type access
// global _EnumMode_			// uncomment for Pmac enum data type checking on Set & Get global functions		// uncomment for Pmac Script type access
...
//---------------------------------------------------------------------
//----------------------------------------------
// Uncomment the below global to run as a RT Linux APP
// global RUN_AS_RT_APP
// For older F/W uncomment the following if you get a compile error:
// global BACKGROUND_RT_PRIORITY 50
// global NANO_5MSEC 5000000
//----------------------------------------------

  struct sched_param param;
  int done = 0;
	struct timespec sleeptime = {0};
	sleeptime.tv_nsec = NANO_5MSEC;	// globals NANO_1MSEC, NANO_5MSEC & NANO_10MSEC are defined
